...
public class AddSampleData {
	...
	public static void addSampleData() {
		...
		App.addReportListEntry(new DataEntry("Stan Tymiñski", "pisanie maili", LocalDate.parse("2016-10-03", App.getDF()), 5.5));
		App.addReportListEntry(new DataEntry("Janusz Zawodny", "czytanie maili", LocalDate.now(), 7.75));
		App.addReportListEntry(new DataEntry("Stan Tymiñski", "zarz¹dzanie zasobami ludzkimi", LocalDate.parse("2018-01-01", App.getDF()), 15.0));
		App.addReportListEntry(new DataEntry("Jan Kodziñski", "programowanie", LocalDate.parse("2017-07-01", App.getDF()), 2.5));
