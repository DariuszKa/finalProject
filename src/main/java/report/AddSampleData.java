...
public interface AddSampleData {
	...
	public default void addSampleData(App data) throws WrongDataEntryValueException {
		...
		data.addReportListEntry(new DataEntry("Jeff Kowalski", "czytanie maili", LocalDate.parse("2015-11-12", App.getDF()), 4.0));
		...
		data.addReportListEntry(new DataEntry("Abraham Lincoln", "zarz¹dzanie zasobami ludzkimi", LocalDate.parse("2017-06-29", App.getDF()), 11.0));
		...
		data.addReportListEntry(new DataEntry("Stan Tymiñski", "zarz¹dzanie zasobami ludzkimi", LocalDate.parse("2017-01-01", App.getDF()), 15.0));
		...
		data.addReportListEntry(new DataEntry("Agata G¹sienica", "zarz¹dzanie zasobami ludzkimi", LocalDate.now(), 20));
